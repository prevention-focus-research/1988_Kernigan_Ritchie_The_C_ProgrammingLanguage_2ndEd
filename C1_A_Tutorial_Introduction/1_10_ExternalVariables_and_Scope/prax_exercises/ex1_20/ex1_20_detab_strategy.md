...
### operationalizing copy with spaces:

operationalizing the addition of spaces into a new line, and then continuing to copy from the position after the tab in the original line over to the new line:
